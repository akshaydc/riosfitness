...
router.get('/public/:receiptId', async (req, res) => {
  try {
    const { rows } = await pool.query(
      `SELECT id, member_name, membership_id, amount, method, paid_date,
              recorded_by, new_due_date, note, subscription_type, balance_pending
